"""
Django settings for instahunter project.
"""
...
# SSL Proxy Header (Needed for Easypanel/Nginx)
...
MIDDLEWARE = [
    ...
    'whitenoise.middleware.WhiteNoiseMiddleware', # Whitenoise Middleware MUST be here
...
WSGI_APPLICATION = 'instahunter.wsgi.application'

# Database
# Use DATABASE_URL environment variable if it exists, otherwise use SQLite
DATABASES = {
...
# Password validation
# ... (mantendo os validadores originais)
...
# Usando a versão simples para evitar erros de arquivo não encontrado no manifesto
